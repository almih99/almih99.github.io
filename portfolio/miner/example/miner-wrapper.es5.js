...
document.addEventListener("DOMContentLoaded", initialize); // initialization
...
function initialize() {
  ...
  document.addEventListener("minerfail", onFail); // Start timer

  setInterval(onTick, 200); // Create field
